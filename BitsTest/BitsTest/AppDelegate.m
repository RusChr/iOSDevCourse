...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    */
    ...
    student.subjectType = CHRStudentSubjectTypeAnatomy | CHRStudentSubjectTypeDevelopment | CHRStudentSubjectTypeEngineering |
    CHRStudentSubjectTypeMath;
